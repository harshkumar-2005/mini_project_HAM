...
Revision ID: 4310299806b3
Revises: 
Create Date: 2025-02-11 00:30:39.134869
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], name='enrollments_ibfk_2', ondelete='CASCADE'),
